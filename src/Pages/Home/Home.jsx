...
const slides = [
  {
    id: 1,
    imageUrl:
      "https://kindergarten.thimpress.com/demo-3/wp-content/uploads/sites/6/2019/03/img-slider-31-min.png",
    title: "Welcome to Fabble",
    description: "Larning Program ",
  },
  {
    id: 2,
    imageUrl:
  ...
  return (
    <>
      <div className="home-wrapper ">
        ...
        <section className="containere  ">
          <div className="carousel-containerr">
            {slides.map((slide, index) => (
              ...
              >
                <div className="carousel-captionn d-none d-lg-block">
            ...
            <button className="prev-btn d-lg-block d-none" onClick={prevSlide}>
              &#10094;
            </button>
            <button className="next-btn d-lg-block d-none" onClick={nextSlide}>
              &#10095;
            </button>
            <div className="indicators d-lg-block d-none">
              {slides.map((_, index) => (
                <div
                  key={index}
                  className={`indicator ${
        ...
        <section className=" p-3 sec1 mt-5">
          <div className="d-flex flex-lg-row container flex-column align-items-center">
            <div className="w-100">
              <h1 className="home-heading">
                Introducing NextGen Kindergarten Management
              </h1>
              <p>
                Welcome to Kidio, where we're revolutionizing digital solutions
                to streamline daycare administration for the advantage of
                administrators, staff, and parents alike.
              </p>
          ...
          <div className="row mt-5">
            ...
            <div className="col-lg-6 col-12  your-child mt-5">
              <h4>PART OF THE FAMILY SINCE 2015,</h4>
              <h1>
                Your child will be at the forefront of their learning journey.
              </h1>
              <p>
                We're continuously broadening our array of services to cater to
                children of various age groups. Our aim is to nurture and
                enhance children's development in an enjoyable manner. We
                endeavor to transform the educational journey into an engaging
                experience, ensuring that children learn with joy.
              </p>
        ...
        <section className="container-xxl">
          <div className="row  u">
            <div className="col-12 d-flex justify-content-center">
              <p className="ex">
                Exceptional characteristics for <br /> Enhanced Efficiency
              </p>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 op mt-3  ">
              <div className="x">
                ...
                <p>
                  Administer enrollment, personnel, financials, and reporting
                  effortlessly using a comprehensive dashboard tailored for
                  streamlined management. Boost effectiveness and oversight.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 op mt-3  ">
